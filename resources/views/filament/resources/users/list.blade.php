<x-filament-panels::page>
    ...
    <div class="mb-8 -mt-6 -mx-6 px-6 py-8 bg-gradient-to-br from-violet-50 via-purple-50 to-indigo-50 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 border-b border-gray-200 dark:border-gray-700 edison-bg-mesh">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-extrabold bg-gradient-to-r from-violet-600 to-purple-600 bg-clip-text text-transparent tracking-tight">
                    {{ $this->getTitle() }}
                </h1>
        ...
        <div class="mt-6 grid grid-cols-1 md:grid-cols-4 gap-4">
            @php
                $stats = [
                    ...
                    [
                        'label' => 'Companies',
                        'value' => \App\Models\User::distinct('company_id')->count('company_id'),
    ...
    @if($this->getTable()->getRecords()->isEmpty() && !$this->getTable()->getFilters())
        <x-empty-state
            ...
            description="Build your team by inviting members. Assign roles, manage permissions, and collaborate effectively."
            action-label="Add Team Member"
            :action-url="route('filament.admin.resources.users.create')"
        />
    @else
