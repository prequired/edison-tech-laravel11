    ...
    <div class="bg-white rounded-lg shadow-sm p-8">
        <form action="{{ route('admin.users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="Asia/Singapore" {{ old('timezone', $user->timezone) === 'Asia/Singapore' ? 'selected' : '' }}>Singapore</option>
                        <option value="Asia/Kolkata" {{ old('timezone', $user->timezone) === 'Asia/Kolkata' ? 'selected' : '' }}>India Standard Time</option>
            ...
            <div class="mb-6">
                ...
                <div class="border-2 border-dashed border-gray-300 rounded-lg p-6">
                    <input
                        ...
                        class="w-full"
                    />
                    <p class="text-xs text-gray-500 mt-2">Accepted formats: JPG, PNG, GIF. Max size: 5MB. Leave blank to keep current avatar.</p>
                </div>
                @error('avatar')
                    <p class="text-red-600 text-sm mt-2">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-8">
                ...
                @if(auth()->id() === $user->id)
                    <p class="text-xs text-gray-500 mt-2">You cannot deactivate your own account</p>
                @endif
                @error('is_active')
                    <p class="text-red-600 text-sm mt-2">{{ $message }}</p>
                @enderror
