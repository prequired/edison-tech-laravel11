...
<div class="py-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        <!-- Form Card -->
        <div class="lg:col-span-3 bg-white rounded-lg shadow-sm p-8">
            <form action="{{ route('admin.projects.update', $project->id) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    >{{ old('technologies', is_array($project->technologies) ? implode(', ', $project->technologies) : $project->technologies) }}</textarea>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 h-fit">
            ...
            <p class="text-sm text-gray-600 mb-6">Once you delete this project, there is no going back. Please be certain.</p>

            <form
                action="{{ route('admin.projects.destroy', $project->id) }}"
                method="POST"
                onsubmit="return confirm('Are you absolutely sure you want to delete this project? This action cannot be undone.')"
            >
                @csrf
                @method('DELETE')
                <button
                    type="submit"
                    class="w-full px-4 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 transition duration-200 font-medium flex items-center justify-center gap-2"
                >
