    ...
    <div class="mx-auto max-w-3xl">
        <form method="POST" action="{{ route('admin.testimonials.store') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="overflow-hidden rounded-lg bg-white shadow">
                ...
                <div class="px-6 py-5 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="client_name" id="client_name" value="{{ old('client_name') }}" required maxlength="255" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('client_name') border-red-300 @enderror">
                        @error('client_name')
                    ...
                    <div>
                        ...
                        <input type="text" name="client_position" id="client_position" value="{{ old('client_position') }}" required maxlength="255" placeholder="e.g., CEO, Marketing Director" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('client_position') border-red-300 @enderror">
                    ...
                    <div>
                        ...
                        <input type="text" name="company_name" id="company_name" value="{{ old('company_name') }}" maxlength="255" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('company_name') border-red-300 @enderror">
                        @error('company_name')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="email" name="client_email" id="client_email" value="{{ old('client_email') }}" maxlength="255" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('client_email') border-red-300 @enderror">
            ...
            <div class="overflow-hidden rounded-lg bg-white shadow">
                ...
                <div class="px-6 py-5 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="testimonial" id="testimonial" rows="6" required maxlength="1000" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('testimonial') border-red-300 @enderror">{{ old('testimonial') }}</textarea>
            ...
            <div class="overflow-hidden rounded-lg bg-white shadow">
                ...
                <div class="px-6 py-5 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="display_order" id="display_order" value="{{ old('display_order', 0) }}" min="0" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('display_order') border-red-300 @enderror">
            ...
            <div class="flex justify-end space-x-3">
                <a href="{{ route('admin.testimonials.index') }}" class="rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
                    Cancel
                </a>
