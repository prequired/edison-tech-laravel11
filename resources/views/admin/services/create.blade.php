...
<div class="py-6">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-gray-600 mt-1">Add a new service to your system</p>
        </div>
        <a
...
function addFeature() {
    ...
    const oldValue = document.querySelector(`input[name="features.${featureCount - 1}"]`)?.value || '';
